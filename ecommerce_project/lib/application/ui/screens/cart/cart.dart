...
class _CartWidgetState extends State<CartWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CartBloc>(
        create: (context) => CartBloc(cartRepository)..add(CartLoadEvent()),
        child: Scaffold(body: BlocBuilder<CartBloc, CartState>(builder: (context, state) {
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ElevatedButton(
                    ...
                    child: const Icon(Icons.arrow_back_ios_new_sharp, size: 19, color: Colors.white),
                                  ...
                                  return Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        trailing: ElevatedButton(
                                            onPressed: () {},
                                            style: ElevatedButton.styleFrom(
                                                shape: const CircleBorder(), primary: AppColors.buttonBarColor),
                                            child: SvgPicture.asset(
                                              assetCart,
                                              // color: Colors.red,
                                              height: 19,
